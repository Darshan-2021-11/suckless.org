...
static const char *fonts[]          = { "monospace:style=Regular:pixelsize=18:antialias=true:autohint=true" };
static const char dmenufont[]       = "monospace:style=Regular:pixelsize=18:antialias=true:autohint=true";
