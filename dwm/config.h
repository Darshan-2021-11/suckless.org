...
static const char *fonts[]          = { "Cantarell:style=Regular:pixelsize=16:antialias=true:autohint=true" }; //{ "monospace:style=Regular:pixelsize=18:antialias=true:autohint=true" };
static const char dmenufont[]       = "Cantarell:style=Regular:pixelsize=16:antialias=true:autohint=true"; //"monospace:style=Regular:pixelsize=18:antialias=true:autohint=true";
