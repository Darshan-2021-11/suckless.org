...
static const char *fonts[]          = { "Source Code Pro:style=Regular:pixelsize=18:antialias=true:autohint=true" }; //{ "monospace:style=Regular:pixelsize=18:antialias=true:autohint=true" };
static const char dmenufont[]       = "Source Code Pro:style=Regular:pixelsize=18:antialias=true:autohint=true"; //"monospace:style=Regular:pixelsize=18:antialias=true:autohint=true";
